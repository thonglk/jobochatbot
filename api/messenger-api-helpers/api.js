...
import { PAGE_ACCESS_TOKENS } from 'config/app-config';
...
const callAPI = (endPoint, messageDataArray, queryParams = {}, retries = 5) => {
  ...
  const querys = PAGE_ACCESS_TOKENS.map(PAGE_ACCESS_TOKEN => Object.assign({ access_token: PAGE_ACCESS_TOKEN }, queryParams));
...
const callMenuAPI = (messageDataArray, queryParams = {}) => {
